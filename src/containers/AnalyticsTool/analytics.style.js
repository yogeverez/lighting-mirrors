...
import polygon from '../../common/assets/image/polygon.png';

const Section = styled(Parallax)`
  /* background: #373754 url(${parallaxBg}) no-repeat fixed center center / cover; */
  ...
  .container {
    @media (min-width: 768px) {
      /* position: relative;
      ::after {
        background: transparent url(${polygon}) no-repeat;
        content: '';
        right: 0;
        position: absolute;
        width: 104px;
