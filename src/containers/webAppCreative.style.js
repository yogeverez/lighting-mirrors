...
import bgPattern from "../common/assets/image/pattern3.png";
import pattern5 from "../common/assets/image/pattern5.png";
import pattern6 from "../common/assets/image/pattern6.png";
import pattern7 from "../common/assets/image/pattern7.png";
...
export const CombinedSection = styled.section`
  background: #373754 url(${bgPattern}) no-repeat center;
  position: relative;
  z-index: 0;
...
export const CornerPattern = styled.div`
  background: url(${pattern5}) left top no-repeat,
    url(${pattern6}) right top no-repeat,
    url(${pattern7}) right bottom no-repeat;
  position: absolute;
  left: 0;
  top: -30px;
  bottom: -30px;
